...
export interface EnemyDef {
  ...
  tameable?: boolean;    // can be fed + tamed into a rideable mount (rare)
  rideSpeed?: number;    // mounted speed multiplier vs walking (default 1.8)
}
...
export const ENEMY_WORLDS: Record<string, WorldEnemies> = {
  ...
  flat: {
    ...
    defs: [
      d('gloomling', 'Gloomling', m('crawler', 0x2a2438, 0x3a3050, 0xc890ff), 0.9, 10, 2.4, 0.07, 'swarm', [Item.VoidShard], { spawnTime: 'night', weight: 20 }),
      d('dusty-strider', 'Dusty Strider', m('quad', 0xb09868, 0xd8c090, 0x2a2018, { ears: true }), 1.0, 12, 2.1, 0.0, 'roam', [Item.RawMeat, Item.LeafFiber], { spawnTime: 'day', weight: 10, tameable: true, rideSpeed: 1.9 }),
    ],
  },
  ...
  prehistoric: {
    ...
    defs: [
      ...
      d('horned-grazer', 'Horned Grazer', m('dino', 0x7a6848, 0xd8d0b8, 0x2a2018, { bulky: true, horns: true }), 1.5, 35, 2.2, 0.12, 'roam', [Item.RawMeat, Item.PrimalHide], { chargeOnHit: true, spawnTime: 'day', weight: 14, attackRange: 1.9, tameable: true, rideSpeed: 2.0 }),
      d('longneck-titan', 'Longneck Titan', m('dino', 0x8a9a6a, 0x6a7a4f, 0x2a2018, { bulky: true, longNeck: true }), 2.6, 60, 1.4, 0.0, 'roam', [Item.RawMeat, Item.PrimalHide, Item.LeafFiber], { spawnTime: 'day', weight: 7, tameable: true, rideSpeed: 1.7 }),
      d('armored-anklo', 'Armored Anklo', m('dino', 0x5a5a48, 0x8a8a70, 0x2a2018, { bulky: true, club: true, plates: true }), 1.4, 50, 1.6, 0.14, 'roam', [Item.FossilShard, Item.PrimalHide], { chargeOnHit: true, weight: 9, attackRange: 2.0, tameable: true, rideSpeed: 1.7 }),
  ...
  zombie: {
    ...
    defs: [
      ...
      d('stray-hound', 'Stray Hound', m('quad', 0x8a7458, 0x6a5640, 0xffd070, { ears: true }), 1.0, 12, 3.0, 0.0, 'roam', [Item.RawMeat], { spawnTime: 'day', weight: 8, tameable: true, rideSpeed: 2.0 }),
    ],
  },
  ...
  battlefront: {
    ...
    defs: [
      ...
      d('war-mule', 'War Mule', m('quad', 0x6a5a44, 0x4e4232, 0x2a2018, { ears: true }), 1.15, 20, 2.0, 0.0, 'roam', [Item.RawMeat, Item.CannedFood], { spawnTime: 'day', weight: 7, tameable: true, rideSpeed: 1.8 }),
    ],
  },
  ...
  medieval: {
    ...
    defs: [
      ...
      d('wolf', 'Grey Wolf', m('quad', 0x6a6a72, 0x4a4a52, 0xffd040, { ears: true }), 1.0, 14, 3.4, 0.08, 'pack', [Item.RawMeat, Item.PrimalHide], { packSize: 3, spawnTime: 'night', weight: 12, tameable: true, rideSpeed: 2.1 }),
  ...
  haunted: {
    ...
    defs: [
      ...
      d('pale-mare', 'Pale Mare', m('quad', 0xd8d8e0, 0xb0b0c0, 0xc890ff, { ears: true }), 1.1, 16, 2.6, 0.0, 'flee', [Item.MoonHerb], { spawnTime: 'night', weight: 7, tameable: true, rideSpeed: 2.0 }),
    ],
  },
  ...
  frozen: {
    dayMax: 5, nightMax: 9, spawnEvery: 2.9,
    defs: [
      d('frost-wolf', 'Frost Wolf', m('quad', 0xc8d8e4, 0x9ab4c4, 0x7df0ff, { ears: true }), 1.0, 14, 3.3, 0.08, 'pack', [Item.RawMeat, Item.PrimalHide, Item.CrystalShard], { packSize: 3, weight: 18, tameable: true, rideSpeed: 2.1 }),
  ...
  pirate: {
    ...
    defs: [
      ...
      d('crab-beast', 'Crab Beast', m('spider', 0xc85030, 0x8a3220, 0xffe080), 1.1, 20, 2.4, 0.09, 'chase', [Item.RawMeat, Item.GoldIngot], { weight: 12, tameable: true, rideSpeed: 1.8 }),
  ...
  wasteland: {
    ...
    defs: [
      ...
      d('infected-dog', 'Infected Dog', m('quad', 0x5a5040, 0x6a7040, 0xb6ff30, { ears: true }), 0.9, 10, 3.6, 0.07, 'pack', [Item.InfectedTissue, Item.PrimalHide], { packSize: 3, weight: 16, tameable: true, rideSpeed: 2.0 }),
  ...
  // peaceful park — only friendly ponies wander the grounds
  themepark: {
